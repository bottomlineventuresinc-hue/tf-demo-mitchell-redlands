/* Template Factory - Clay Mitchell Electrical live demo journey.
...
(function () {
  ...
  var LIVE_URL = 'https://bottomlineventuresinc-hue.github.io/tf-demo-mitchell-redlands/';
  var LS_CHANGES = 'tf_mitchell_change_log_v1';
  var LS_PURCHASED = 'tf_mitchell_purchased_v1';
  ...
  var demoEdits = [
    ...
    },
    {
      ...
      apply: function () {
        if (heroH) {
          heroH.innerHTML = 'Panels and home wiring,<br>quoted <em>before</em> we start.';
        }
      }
    },
    {
  ...
  function setBarMode(mode) {
    ...
    if (!barSub) return;
    if (mode === 'updated') {
      barSub.textContent = 'Draft for Clay at Clay Mitchell Electrical. Claim it, preview the rest of the journey, or request a change.';
    } else {
      barSub.textContent = 'Draft for Clay at Clay Mitchell Electrical. Claim it, preview the rest of the journey, or request a change.';
    }
  }
  ...
  if (changeForm) {
    changeForm.addEventListener('submit', function (e) {
      ...
      runSpinner(
        ...
        'Updating the draft for Clay Mitchell Electrical. Hang tight.',
        delay,
        function () {
